# MS01 1.54" Dual-System E-Ink Tracker

> Smart Bluetooth Photo Keychain with Apple Find My & Android Support
...
**Use cases:** Keychain · Pet Tag · Backpack Charm · Car Decoration · Luggage Tag · Personal Item Tracker
...
| Tracking | **Dual-system support:** Apple Find My + Android |
| Battery | Long-lasting button cell |
| Shell | Premium ABS construction |
| Display | Always-on, power-efficient e-ink technology |
...
2. Insert the button cell battery — **positive (+) side facing up**
...
4. Tap **"Upload"** → wait 10–15 seconds for the e-ink screen to refresh
...
**Storage:** Save multiple photos in the app library and switch between them anytime.
...
The MS01 also works seamlessly with Android devices through the FindXeink app:
...
### 🐾 Smart Pet ID Tag
Show your pet's photo + contact info. Track location via Find My or Android if your pet gets lost.
...
### 🧳 Luggage Tag
Contact info for lost luggage recovery + cross-platform tracking support.
...
3. Insert new button cell — positive side up
4. Close compartment
...
| Find My not working | Ensure iOS 14.5+; check Apple ID settings; re-add device |
...
Yes! The MS01 supports both ecosystems — Apple Find My for iOS users and full Android app support.

**Q: Is it waterproof?**
Splash-resistant — handles light rain and accidental splashes, but should not be submerged.

**Q: Can I switch between iOS and Android?**
Yes, the device can be paired with either platform. However, Apple Find My features require an iOS device.
...
| Tracking | Apple Find My + Android support |
| Battery | Button cell (CR2025/CR2026) |
...
*Carry your memories everywhere. Never lose what matters — on any platform.*
